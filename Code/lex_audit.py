...
plt.tight_layout()
plt.savefig("INDP//Images//VADER_sentiment.png")
...
plt.tight_layout()
plt.savefig("INDP//Images//VADER_sentconf.png")
...
g.tight_layout()
g.savefig("INDP//Images//VADER_sentiment_search_term.png")
...
g.set_titles(col_template = '{col_name}')
g.tight_layout()
g.savefig("INDP//Images//VADER_sentconf_search_term.png")
...
plt.tight_layout()
plt.savefig("INDP//Images//VADER_sentiment_sentconf.png")
...
for cat in df_VADER_unique.drop_duplicates(['sentiment_cat'])['sentiment_cat'].tolist():
    ...
    plt.axis("off")
    plt.savefig('INDP/Images/VADER_wordcloud_excstopwords_{0}.png'.format(cat))
